...
class WordTrigger(Trigger):
    ...
    def isWordIn(self, text):
        """
        text:list
        return bool(instance's attr word is in the text list?)
        """
    ...
    def prepareText(self, text):
        ...
        text:string
        return list
        remove string all punctuation symbol, then split it up to list
        """
...
class TitleTrigger(WordTrigger):
    ...
    def evaluate(self, story):
        ...
        return bool
        check is word in the story's title
        """
...
class SubjectTrigger(WordTrigger):
    ...
    def evaluate(self, story):
        ...
        story:NewsStory instance
        return bool
        check is word in the story's subject
        """
...
class SummaryTrigger(WordTrigger):
    ...
    def evaluate(self, story):
        ...
        story:NewsStory instance
        return bool
        check is word in the story's summary
        """
...
class AndTrigger(Trigger):
    ...
    def __init__(self, t1, t2):
        """
        t1:any WordTrigger sub class
        t2:any WordTrigger sub class
        """
        self.t1 = t1
        self.t2 = t2
    ...
    def evaluate(self, text):
        ...
        text:string
        return bool
        is text match two triger evaluate both
        """
...
class OrTrigger(Trigger):
    ...
    def evaluate(self, text):
        ...
        text:string
        return bool
        is text match two triger evaluate any one
        """
...
class PhraseTrigger(Trigger):
    ...
    def evaluate(self, story):
        ...
        story:NewsStory instance
        return bool
        check phrase is in the store's attribute
        """
        # get all story attribute
        storyAttrList = [story.getGuid(), story.getTitle(),
                         story.getSummary(), story.getSubject(), story.getLink()]
        # if the phrase in any attribute
        if any(self.phrase in attr for attr in storyAttrList):
            return True
        return False
...
def makeTrigger(triggerMap, triggerType, params, name):
    ...
    # there not, and, or trigger should take already create trigger from map
...
def main_thread(master):
    ...
    try:
        ...
        ttl.pack(side=TOP)
        cont = Text(
            master, font=("Helvetica", 14), yscrollcommand=scrollbar.set)
