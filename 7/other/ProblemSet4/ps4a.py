...
def getWordScore(word, n):
    ...
    # length of word
    wordLen = len(word)
    # loop through of word, check every letter score
    # use SCRABBLE_LETTER_VALUES dict
    for letter in word:
        score += SCRABBLE_LETTER_VALUES[letter]
    # score need multiplied by word length
    score *= wordLen
    # if length equal to n, score plus 50
    if wordLen == n:
        score += 50
    return score
...
def updateHand(hand, word):
    ...
    """
    # TO DO ... <-- Remove this comment when you code this function
    # reset dict value to 0
    # copy new hand
    newhand = dict(hand)
    # loop through word, if
    for letter in word:
        newhand[letter] = newhand.get(letter, 2) - 1
    return newhand
    ...
    * The hand finishes when there are no more unused letters or the user
    ...
    while True:
        ...
        if not isValid:
            ...
            currentScore = getWordScore(userWord, n)
            print(userWord, 'earned', currentScore, 'points.', end='')
